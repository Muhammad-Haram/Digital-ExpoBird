    ...
    <Fragment>
      ...
      <div className="bg-[#ffffff] overflow-x-hidden font-montserrat">
        ...
        <div className="py-[2rem]">
                <h5 className="text-[80px] font-black text-black md:flex md:justify-center">Services</h5>
              </div>
              ...
              <div className=" md:pt-0  md:h-auto md:mb-[200px] lg:h-auto lg:mb-[200px]">
                <div>
                  ...
                  <Link href="/services/web">
                    {/* <button className="buttonv2 justify-end px-6 py-4 rounded-[40px] text-[#fff] text-[17px] font-semibold ml-[140px] sm:flex sm:items-center sm:m-auto md:flex md:items-center md:mx-auto">
            ...
            <div className="col-span-6">
              <div className="pt-[2rem]  md:h-auto md:mb-[100px] lg:h-auto lg:mb-[200px]">
                <div className="bg-white shadow-md p-4 rounded-lg">
                  <p className="text-[40px] text-black font-bold pl-5 md:text-center" data-inviewport >Digital Marketing</p>
                  <p className="text-[20px] text-black font-medium max-w-[70%] pl-5 py-3 md:text-center">We imagine and build experiences and businesses that win hearts and realize the future. Explore how we work.</p>
          ...
          <div className=" grid grid-cols-12 sm:grid sm:grid-cols-1">
            ...
            <div className="col-span-6">
              <div className=" md:h-auto md:mb-[100px] lg:h-auto lg:mb-[200px]">
                <div className="">
                  {/* <p className="text-[40px] text-black font-bold pl-5 md:text-center" data-inviewport >Digital Marketing</p>
                  <p className="text-[20px] text-black font-medium max-w-[70%] pl-5 py-3 md:text-center">We imagine and build experiences and businesses that win hearts and realize the future. Explore how we work.</p> */}
                  {/* <Image src="/assets/digital-branding.webp" height={0} width={400} className="py-3" alt="" /> */}
                                   <video height={0} width={600} className="" alt="" autoPlay={true}
                    muted={true}
                    loop={true}
                    src="/assets/ecommerce.webm" type="video/webm" >
                    Your browser does not support the video tag.
