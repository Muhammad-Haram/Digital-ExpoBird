          ...
          <section className="py-24 sm:py-4 md:py-30 w-full sm flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="mt-[24px] sm:mt-[20px] md:text-[30px] rotating-words text-center relative">
                ...
                <span className="sm:text-[35px] md:text-[30px] lg:text-[45px] block text-[42px] text-white font-black bg-[#7B41F9] rounded-[60px] left-1/2 -translate-x-2/4 px-8 md:px-10 md:mb-10">Mobile App <br /> Development</span>
