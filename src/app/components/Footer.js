          ...
          <div className="px-24 sm:px-8">
            <div className="sm:grid sm:grid-cols-1 grid grid-cols-3">
              <div className="sm:border-none border-r-2 sm:py-10 border-[#FFFFFF] py-24 ">
                <p className="text-white sm:text-[16px] sm:leading-none sm:text-center sm:py-4 text-[24px] py-20">New York Division One World Trade Center New York, NY 10007</p>
              ...
              <div className="col-span-2 sm:col-span-1 sm:py-0 py-24">
                <div className="sm:border-none border-b-2 border-[#FFFFFF] ">
                  ...
                  <p className="sm:text-[16px] text-[24px] sm:pl-0 sm:relative sm:text-center text-white max-w-[500px] sm:my-5 sm:leading-none my-10 pl-16">We are a team of design and research experts with over ten years of experience in improving businesses and peoples’ lives through smart design solutions</p>
                ...
                <div>
                  ...
                  <Link href="/" className="sm:text-[16px] sm:no-underline underline underline-offset-1 text-white py-2 text-[20px]">Web Development</Link>
                    <Link href="/" className="sm:text-[16px] sm:no-underline underline underline-offset-1 text-white py-2 text-[20px]">amazon Service</Link>
                    <Link href="/" className="sm:text-[16px] sm:no-underline underline underline-offset-1 text-white py-2 text-[20px]">Graphic Designing</Link>
                    <Link href="/" className="sm:text-[16px] sm:no-underline underline underline-offset-1 text-white py-2 text-[20px]">Mobile App Development</Link>
                    <Link href="/" className="sm:text-[16px] sm:no-underline underline underline-offset-1 text-white py-2 text-[20px]">UI/UX Design</Link>
                    <Link href="/" className="sm:text-[16px] sm:no-underline underline underline-offset-1 text-white py-2 text-[20px]">Digital Marketing</Link>
                    <Link href="/" className="sm:text-[16px] sm:no-underline underline underline-offset-1 text-white py-2 text-[20px]">Social Media Marketing</Link>
                    <Link href="/" className="sm:text-[16px] sm:no-underline underline underline-offset-1 text-white py-2 text-[20px]">Search Engine Optimization</Link>
                  </div>            
