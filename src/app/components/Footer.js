...
const Footer = () => {
  return (
    ...
    <>
      <div className='sm:pb-[20px] sm:pt-[20px] sm:px-[20px] md:pb-[30px] md:pt-[30px] md:px-[30px] lg:pb-[40px] lg:pt-[50px] lg:px-[50px]  w-full bg-[#E3204A] #000213 relative z-[-2] text-white pb-[50px] pt-[70px] p-[100px] box-border' >

        <div className=''>
          <h1 className='sm:ml-0 sm:text-[30px] md:text-[40px] md:ml-0 lg:text-[40px] lg:ml-0 ml-[40px] mb-[40px] text-[#ffffff00] text-[80px] font-montserrat font-bold tracking-[1px]'
          ...
          <div className='sm:items-start sm:flex-col sm:gap-[40px] md:flex-col md:items-start md:gap-[40px] lg:flex-col lg:items-start lg:gap-[40px] flex w-full items-center justify-between'>
            <div className='left'>
              ...
              <div className='sm:flex-col md:flex-col lg:flex-col flex gap-[30px]'>
            ...
            <div className='sm:flex-wrap right box-border flex gap-[50px]'>
              <div>
