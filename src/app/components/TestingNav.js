...
const TestingNav = () => {
	...
	return (
		<Fragment>
			...
			{
				<aside className={showNav ? "sm:bg-[#000213] md:bg-[#000213] font-montserrat sm:h-[790px] sm:mt-[40px] sm:absolute sm:w-full md:absolute md:w-full cursor-pointer sm:text-white md:text-white accordion-nav lg:hidden xl:hidden 2xl:hidden" : "hidden sm:bg-[#000213] md:bg-[#000213] md:absolute md:w-full md:mt-[20px] cursor-pointer sm:absolute font-montserrat sm:text-white sm:w-full sm:h-[740px] md:h-[1000px] sm:mt-[20px] accordion-nav  lg:hidden xl:hidden 2xl:hidden"}>
