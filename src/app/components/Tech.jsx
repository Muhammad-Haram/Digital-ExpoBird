    ...
    <>
     <div className="font-montserrat xl:max-w-[1440px] bg-[#000213] sm:max-w-[500px] mx-auto">
        <div className="p-10 sm:p-0">
          <h6 className="sm:text-[40px] sm:text-center sm:mt-[50px] sm:ml-[5px] ml-[60px] md:text-[50px] lg:text-[60px] sm:font-extrabold text-[#ffff] text-[80px] font-bold">Futuristic Technology Unique To All Business Needs</h6>
        </div>
