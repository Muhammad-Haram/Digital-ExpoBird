    ...
    return (
        <>
         ...
         development solutions to empower startups, SMBs, enterprises and brands."}
                    text1={"We Are"} text2={"E-commerce Development"} text3={"Company"}
                />
            </div>
            <FeatureWork title={"We are a team of developers and research experts with over ten years of experience in improving businesses and peoples’ lives through smart design"}
            />
          <Driven />
            <Footer />
        </>
